    ...
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("1de6536a-ed8d-4337-b12b-5dcff625548f"), new Guid("2f35d00e-6ef3-435e-9799-f374dce8f54a") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 2, "vi", "Áo nữ", "ao-nu", "Sản phẩm áo thời trang nữ", "Sản phẩm áo thời trang nữ" },
                    { 3, 1, "vi", "Áo nam", "ao-nam", "Sản phẩm áo thời trang nam", "Sản phẩm áo thời trang nam" },
                    { 1, 1, "en", "Men Shirt", "men-shirt", "The shirt product for men", "The shirt product for men" },
