...
namespace eShopSolution.AdminApp.Services
{
    public class RoleApiClient : IRoleApiClient
    {
        ...
        public async Task<ApiResult<List<RoleVm>>> GetAll()
        {
            ...
            {
                List<RoleVm> myDeserializedObjectList = (List<RoleVm>)JsonConvert.DeserializeObject(body, typeof(List<RoleVm>));
                return new ApiSuccessResult<List<RoleVm>>(myDeserializedObjectList);
            }
