...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        Task<List<ProductImageViewModel>> IProductService.GetListImages(int productId)
        {
